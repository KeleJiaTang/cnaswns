...
{
    public partial class HCSRS_select_washerdevice : TemplateForm
    {
        public SortedList washing = new SortedList();
        public HCSRS_select_washerdevice()
        {
            InitializeComponent();

			Icon = new Icon(ResourcesImageHelper.Instance.GetResourcesStream("Common.icon", "MainIco", EnumImageType.ICO));
			this.Text = ConfigurationManager.AppSettings["SystemName"].ToString() + "--选择清洗机";
        ...
        private void but_select_Click(object sender, EventArgs e)
        {
            ...
            {
                washing.Add("s_name", dgv_01.SelectedRows[0].Cells["s_name"].Value.ToString());
                washing.Add("s_barcode", dgv_01.SelectedRows[0].Cells["s_barcode"].Value.ToString());
                this.Close();
            }
        }

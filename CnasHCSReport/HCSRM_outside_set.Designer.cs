...
{
	partial class HCSRM_outside_set
	{
		/// <summary> 
		/// 必需的设计器变量。
		/// </summary>
		...
		private void InitializeComponent()
		{
			...
			this.but_instrument = new Telerik.WinControls.UI.RadButton();
			...
			((System.ComponentModel.ISupportInitialize)(this.but_instrument)).BeginInit();
			...
			this.splitContainer1.Size = new System.Drawing.Size(932, 579);
			...
			this.radGroupBox1.Controls.Add(this.but_instrument);
			this.radGroupBox1.Controls.Add(this.but_set);
			this.radGroupBox1.Controls.Add(this.cb_customer);
			this.radGroupBox1.Controls.Add(this.cb_location);
			this.radGroupBox1.Controls.Add(this.radLabel2);
			this.radGroupBox1.Controls.Add(this.radLabel1);
			this.radGroupBox1.Dock = System.Windows.Forms.DockStyle.Fill;
			this.radGroupBox1.Font = new System.Drawing.Font("Segoe UI", 11F);
			this.radGroupBox1.GroupBoxStyle = Telerik.WinControls.UI.RadGroupBoxStyle.Office;
			this.radGroupBox1.HeaderText = "查询外来器械包>>主窗口";
			this.radGroupBox1.Location = new System.Drawing.Point(0, 0);
			this.radGroupBox1.Name = "radGroupBox1";
			this.radGroupBox1.Size = new System.Drawing.Size(932, 88);
			this.radGroupBox1.TabIndex = 0;
			this.radGroupBox1.Text = "查询外来器械包>>主窗口";
			this.radGroupBox1.ThemeName = "Office2007Silver";
			// 
			// but_instrument
			// 
			this.but_instrument.Location = new System.Drawing.Point(457, 38);
			this.but_instrument.Name = "but_instrument";
			this.but_instrument.Padding = new System.Windows.Forms.Padding(0, 0, 10, 0);
			this.but_instrument.Size = new System.Drawing.Size(136, 42);
			this.but_instrument.TabIndex = 2;
			this.but_instrument.Text = "查看器械详情";
			this.but_instrument.TextImageRelation = System.Windows.Forms.TextImageRelation.ImageBeforeText;
			this.but_instrument.ThemeName = "Office2007Silver";
			this.but_instrument.Click += new System.EventHandler(this.but_instrument_Click);
			// 
			// but_set
			// 
			this.but_set.Location = new System.Drawing.Point(315, 38);
			this.but_set.Name = "but_set";
			this.but_set.Padding = new System.Windows.Forms.Padding(0, 0, 10, 0);
			this.but_set.Size = new System.Drawing.Size(136, 42);
			this.but_set.TabIndex = 1;
			this.but_set.Text = "查看包详情";
			...
			this.cb_customer.Location = new System.Drawing.Point(96, 38);
			this.cb_customer.Name = "cb_customer";
			this.cb_customer.Size = new System.Drawing.Size(182, 25);
			...
			this.cb_location.Location = new System.Drawing.Point(96, 69);
			this.cb_location.Name = "cb_location";
			this.cb_location.Size = new System.Drawing.Size(182, 25);
			...
			gridViewTextBoxColumn6.HeaderText = "清洗人";
			gridViewTextBoxColumn6.Name = "washinguser";
			gridViewTextBoxColumn6.Width = 150;
			gridViewTextBoxColumn7.HeaderText = "清洗时间";
			gridViewTextBoxColumn7.Name = "washingdate";
			gridViewTextBoxColumn7.Width = 180;
			gridViewTextBoxColumn8.EnableExpressionEditor = false;
			gridViewTextBoxColumn8.HeaderText = "灭菌人";
			gridViewTextBoxColumn8.Name = "sterilizeruser";
			gridViewTextBoxColumn8.Width = 150;
			gridViewTextBoxColumn9.EnableExpressionEditor = false;
			gridViewTextBoxColumn9.HeaderText = "灭菌时间";
			gridViewTextBoxColumn9.Name = "sterilizerdate";
			gridViewTextBoxColumn9.Width = 200;
			gridViewTextBoxColumn10.HeaderText = "batch";
			gridViewTextBoxColumn10.IsVisible = false;
			gridViewTextBoxColumn10.Name = "batch";
			...
			this.dgv_01.Size = new System.Drawing.Size(932, 487);
			...
			((System.ComponentModel.ISupportInitialize)(this.but_instrument)).EndInit();
		...
		private Telerik.WinControls.UI.RadButton but_instrument;

...
{
    public partial class washingno : TemplateForm
    {
        public washingno()
        {
            InitializeComponent();
     ...
     /// </summary>
        ...
        private void rBut_ok_Click(object sender, EventArgs e)
        {
            ...
            bb.Add("errortype", "6");//指标类型
            DataSet result = reCnasRemotCall.RemotInterface.ExecuteProcedure("clean_fail", bb);//根据时间，类型查询返回所需要的数据

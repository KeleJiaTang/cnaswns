...
{
    public partial class HCSRS_DisposeDressing : TemplateForm
    {
        public HCSRS_DisposeDressing()
        {
            InitializeComponent();
            this.Font = new Font(this.Font.FontFamily, 11);
            cb_year.Text = DateTime.Now.Year.ToString();//初始化给年份赋值（）
        ...
        private void rBut_ok_Click(object sender, EventArgs e)
        {
            ...
            DataSet result = reCnasRemotCall.RemotInterface.ExecuteProcedure("dispose_dressing", bb);

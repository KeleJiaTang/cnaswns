...
{
    public partial class HCSRS_sterilizermelt : TemplateForm
    {
        public HCSRS_sterilizermelt()
        {
            InitializeComponent();
        ...
        private void rBut_ok_Click(object sender, EventArgs e)
        {
            ...
            DataSet result = reCnasRemotCall.RemotInterface.ExecuteProcedure("sterilizer", bb);

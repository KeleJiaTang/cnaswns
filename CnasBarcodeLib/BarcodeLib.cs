...
namespace Cnas.wns.CnasBarcodeLib
{
    ...
    public class BarcodeData
    {
        ...
        /// 设计界面高度
        /// </summary>
        [CategoryAttribute("Barcode大小"), DefaultValueAttribute(150)]
        public int Height
        {
            get { return intH; }
            set { intH = value; }
        ...
        /// 设计界面宽度
        /// </summary>
        [CategoryAttribute("Barcode大小"), DefaultValueAttribute(300)]
        public int Width
        {
            get { return intW; }
            set { intW = value; }
        ...
        [CategoryAttribute("值"), DefaultValueAttribute("BCX0000008888")]
        ...
        [CategoryAttribute("参数"), DefaultValueAttribute(true)]
        public bool IsLabel
        {
        ...
        [CategoryAttribute("参数"), DefaultValueAttribute(TYPE.CODE128)]
        ...
        [CategoryAttribute("参数"), DefaultValueAttribute(RotateFlipType.RotateNoneFlipNone)]
        ...
        [CategoryAttribute("参数"), DefaultValueAttribute(AlignmentPositions.CENTER)]
        public AlignmentPositions Alignment
        {
        ...
        [CategoryAttribute("参数"), DefaultValueAttribute(LabelPositions.BOTTOMCENTER)]
        ...
        [CategoryAttribute("参数"), DefaultValueAttribute("FF000000")]
        ...
        [CategoryAttribute("参数"), DefaultValueAttribute("FFFFFFFF")]
        ...
        private int intX = 50;
        [CategoryAttribute("位置"), DefaultValueAttribute(50)]
        public int X
        {
            get { return intX; }
            set { intX = value; }
    ...
    public class DesignFormData
    {
        ...
        /// 设计界面高度
        /// </summary>
        [CategoryAttribute("设计界面大小"), DefaultValueAttribute(250), ReadOnlyAttribute(true)]
        public int Height
        {
            get { return intH; }
            set { intH = value; }
        ...
        /// 设计界面宽度
        /// </summary>
        [CategoryAttribute("设计界面大小"), DefaultValueAttribute(400), ReadOnlyAttribute(true)]
        public int Width
        {
            get { return intW; }
            set { intW = value; }
        ...
        /// 设计界面高度
        /// </summary>
        [CategoryAttribute("条形码大小"), DefaultValueAttribute(150)]
        ...
        /// 设计界面宽度
        /// </summary>
        [CategoryAttribute("条形码大小"), DefaultValueAttribute(300), ReadOnlyAttribute(true)]
        ...
        [CategoryAttribute("打印大小(毫米)"), DefaultValueAttribute(30)]
        ...
        [CategoryAttribute("打印大小(毫米)"), DefaultValueAttribute(40)]
        ...
        [CategoryAttribute("打印大小(毫米)"), DefaultValueAttribute(203)]
        public int DPI
        {
            get { return intDPI; }
            set { intDPI = value; }

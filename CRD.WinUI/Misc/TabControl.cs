...
namespace CRD.WinUI.Misc
{
    public class TabControl : System.Windows.Forms.TabControl
    {
        ...
        internal void DrawTab(Graphics g, TabPage tabPage, int nIndex)
        {
            ...
            g.DrawPolygon(new Pen(Shared.PicboxBorderBackColorYellow), pt);
            ...
            else
            {
               ...
               // g.DrawLine(new Pen(Shared.MainFormBackGroundColor), recBounds.Left + 1, recBounds.Bottom, recBounds.Right - 1, recBounds.Bottom);
                g.DrawLine(new Pen(Shared.PicboxBorderBackColorYellow), recBounds.Left + 1, recBounds.Bottom, recBounds.Right - 1, recBounds.Bottom);
            }

...
namespace CRD.WinUI.Misc
{
    public class Button : CommandButton
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.SuspendLayout();
            if (BtnBitmap==null)
            BtnBitmap = new Bitmap(Bitmap.FromStream(Shared.AssemblyWinUI.GetManifestResourceStream("CRD.WinUI.Resources.MainWin.OurwayPhoto.sb-btn-lv1-2.png")));
            // 
            // lblText
            // 
            ...
            // Button
            // 
            this.NormalImage = BtnBitmap.Clone(new Rectangle(0, 0, 185, 40), PixelFormat.Format64bppPArgb);
            this.MouseMoveImage = BtnBitmap.Clone(new Rectangle(185, 0, 185, 40), PixelFormat.Format64bppPArgb);
            this.MouseDownImage = BtnBitmap.Clone(new Rectangle(370, 0, 185, 40), PixelFormat.Format64bppPArgb);

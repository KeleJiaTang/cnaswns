...
{
    public partial class HCSCM_washing_device_procedure : TemplateForm
    {
        ...
        public HCSCM_washing_device_procedure(SortedList slselect)
        {
            InitializeComponent();
            //设置窗体图标
            ...
            dtall = reCnasRemotCall.RemotInterface.SelectData("HCS-washing-program-sec001", null);
            SortedList sttemp02 = new SortedList();
            sttemp02.Add(1, slselect["id"].ToString());
            dtselect = reCnasRemotCall.RemotInterface.SelectData("HCS-washing-deviceprogram-sec001", sttemp02);
        ...
        private void but_save_Click(object sender, EventArgs e)
        {
            ...
            if (dgv_02.Rows.Count > 0)
            {
                ...
                CnasRemotCall reCnasRemotCall = new CnasRemotCall();
                //string recsql = reCnasRemotCall.RemotInterface.CheckUPData(3, "HCS-washing-deviceprogram-add001", sltmp01, sltmp02);
                int recint = reCnasRemotCall.RemotInterface.UPData(3, "HCS-washing-deviceprogram-add001", sltmp01, sltmp02);
                if (recint > -1)
                {
                    MessageBox.Show(PromptMessageXmlHelper.Instance.GetPromptMessage("successful", EnumPromptMessage.warning, new string[] { "清洗机关联程序" }), "提示信息", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
                }
            }
            else
            {
                ...
                sltmp01.Add(1, sltmp_01);
                CnasRemotCall reCnasRemotCall = new CnasRemotCall();
                string recsql = reCnasRemotCall.RemotInterface.CheckUPData(3, "HCS-washing-deviceprogram-del001", sltmp01, null);
                int recint = reCnasRemotCall.RemotInterface.UPData(1, "HCS-washing-deviceprogram-del001", sltmp01, null);
                if (recint > -1)
                {
                    MessageBox.Show(PromptMessageXmlHelper.Instance.GetPromptMessage("successful", EnumPromptMessage.warning, new string[] { "清洗机关联程序" }), "提示信息", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();

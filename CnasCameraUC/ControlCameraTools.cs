...
using Cnas.wns.CnasCameraUC;
using Cnas.wns.CnasCameraDirectShowLib;

namespace Cnas.wns.CnasCameraUC
{
    public partial class ControlCameraTools : Form
    {
        ...
        public ControlCameraTools()
        {
            InitializeComponent();
        }

        private void ControlCameraTools_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("摄像头异常，请选择手动导入", "提示信息", MessageBoxButtons.OK, MessageBoxIcon.Error);
                this.Close();
                //open_file.ShowDialog();
                //String strOpenFileName = open_file.FileName;
                ...
                //else
                //{
                //    BitmapData = new System.Drawing.Bitmap(strOpenFileName);
        ...
        private void ControlCameraTools_FormClosed(object sender, FormClosedEventArgs e)
        {
            cameraControl.CloseCamera();
        }
        ...
        {
            if(tabc_main.SelectedIndex==1)
            {
                //but_photo_Click(null, null);
                cameraControl.CloseCamera();
            }
        }
    }

...
{
    public class ResourcesImageHelper
    {
		private static ResourcesImageHelper _instance = null;

		public static ResourcesImageHelper Instance
		{
			get
			{
				if (_instance == null)
					_instance = new ResourcesImageHelper();
				return _instance;
			}
		}

		public ResourcesImageHelper()
		{
        ...
        public Assembly AssemblyWinUI
        {
            get
            {
                ...
                {
                    _assemblyWinUI = Assembly.Load("Cnas.wns");
                }

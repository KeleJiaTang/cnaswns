...
namespace Cnas.wns.CnasBaseUC
{
    ...
    public partial class ImageViewer : UserControl
    {
        ...
        private PictureDrawEngine drawEngine;
        private PictureDrawObject drawing;
        ...
        public ImageViewer()
        {
            ...
            drawEngine = new PictureDrawEngine();
            drawing = new PictureDrawObject(this);
            ...
            try
            {
				...
				imgStream = a.GetManifestResourceStream("Cnas.wns.CnasBaseUC.Resources.Grab.cur");
                if (imgStream != null)
                {
				...
				imgStream = a.GetManifestResourceStream("Cnas.wns.CnasBaseUC.Resources.Drag.cur");
                if (imgStream != null)
                {
		...
		{
			toolTip.SetToolTip(btnZoomIn,"放大");
			toolTip.SetToolTip(btnZoomOut, "缩小");
			toolTip.SetToolTip(btnFitToScreen, "适配大小");
			toolTip.SetToolTip(btnMode, "选择");
			toolTip.SetToolTip(cbZoom, "图片比例");
			toolTip.SetToolTip(pbPanel, "缩略图");
        ...
        private void OnImageViewerLoad(object sender, EventArgs e)
        {
        ...
        private void OnImageViewerResize(object sender, EventArgs e)
        {
            InitControl();
            drawing.AvoidOutOfScreen();
            UpdatePanels(true);
        ...
        private void OnpbFullPaint(object sender, PaintEventArgs e)
        {
            // Can I double buffer?
        ...
        private void KP_ImageViewerV2_MouseWheel(object sender, MouseEventArgs e)
        {
            ...
            if (drawing.Image != null)
            {
                if (e.Delta < 0)
                {
                    OnZoom(new ImageViewerZoomEventArgs(drawing.Zoom, EZoom.ZoomOut));
                }
                else
                {
                    OnZoom(new ImageViewerZoomEventArgs(drawing.Zoom, EZoom.ZoomIn));
                }
            }
    ...
    public class ImageViewerZoomEventArgs : EventArgs
    {
        ...
        public ImageViewerZoomEventArgs(double zoom, EZoom inOut)
        {
